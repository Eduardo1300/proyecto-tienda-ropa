<template>
  <div class="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 py-12 relative z-10">
      <div class="mb-12">
        <h1 class="text-5xl font-bold text-white mb-3">💝 Mi Lista de Deseos</h1>
          ...
          <div class="p-6">
            ...
            <div class="flex items-center justify-between mb-6">
              <div class="flex items-center gap-2">
                <span class="text-3xl font-bold text-transparent bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text">${{ item.product?.price }}</span>
              </div>
